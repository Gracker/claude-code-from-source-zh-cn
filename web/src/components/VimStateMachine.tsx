...
const PRESET_SEQUENCES = [
  ...
  { keys: "d2w", label: "d2w", description: "删除 2 个字词" },
  { keys: "cw", label: "cw", description: "更改字词" },
  { keys: "3dd", label: "3dd", description: "删除 3 行" },
  { keys: "yy", label: "yy", description: "复制行" },
  { keys: "p", label: "p", description: "贴上" },
];
...
const STATE_NODES: StateNode[] = [
  ...
  { id: "OPERATOR", label: "运算子", sublabel: "等待中", x: 100, y: 190 },
  { id: "COUNT", label: "计数", sublabel: "等待中", x: 295, y: 190 },
  { id: "OP_COUNT", label: "运算子+计数", sublabel: "等待中", x: 200, y: 300 },
];
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            {!focused && (
              <span className="text-xs opacity-70">点击以聚焦并输入 Vim 命令</span>
            )}
          </div>
          <button
            onClick={(e) => {
