...
function createConversation(): Message[] {
  return [
    { id: "u1", type: "user", label: "建立项目结构", tokens: 400, visible: true, compressed: false, summary: false, height: 28 },
    { id: "a1", type: "assistant", label: "我会建立目录和文件...", tokens: 1200, visible: true, compressed: false, summary: false, height: 36 },
    ...
    { id: "a2", type: "assistant", label: "现在让我来设置构建系统...", tokens: 2400, visible: true, compressed: false, summary: false, height: 38 },
    ...
    { id: "u2", type: "user", label: "现在加入带有 session 的身份验证", tokens: 600, visible: true, compressed: false, summary: false, height: 28 },
    { id: "a3", type: "assistant", label: "我会使用 better-auth 实现基于 session 的验证...", tokens: 3200, visible: true, compressed: false, summary: false, height: 42 },
    ...
    { id: "a4", type: "assistant", label: "验证已设置完成。让我加入中介软件...", tokens: 1800, visible: true, compressed: false, summary: false, height: 36 },
    ...
    { id: "u3", type: "user", label: "为资源加入 CRUD 端点", tokens: 500, visible: true, compressed: false, summary: false, height: 28 },
    { id: "a5", type: "assistant", label: "我会为每个资源建立 tRPC 路由器...", tokens: 4200, visible: true, compressed: false, summary: false, height: 44 },
    ...
    { id: "a6", type: "assistant", label: "路由器已就绪。正在执行类型检查...", tokens: 1600, visible: true, compressed: false, summary: false, height: 34 },
...
const layers: Layer[] = [
  {
    id: 1,
    name: "工具结果预算",
    description: "强制执行每则消息的大小限制。裁切大型工具输出以符合预算。",
    apply: (msgs) =>
      msgs.map((m) => {
  ...
  },
  {
    id: 2,
    name: "剪裁压缩",
    description: "从对话中实际移除旧消息。保留系统提示词和近期上下文。",
    apply: (msgs) => {
  ...
  },
  {
    id: 4,
    name: "上下文折叠",
    description: "用 AI 生成的摘要取代冗长的消息区段。",
    apply: (msgs) => {
  ...
  },
  {
    id: 5,
    name: "自动压缩",
    description: "紧急全文摘要。以简洁摘要取代整个对话。断路器防止重复触发。",
    apply: (msgs) => {
      ...
      return [
        {
          ...
          label: "[自动压缩摘要] 完整 session 上下文：项目设置、验证实现、CRUD 路由器、类型检查通过、测试通过",
    ...
    <div className={className} style={{ fontFamily: "var(--font-serif)" }}>
      ...
      <div style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
        ...
        >
          ...
          >
            对话 ({messages.filter((m) => m.visible).length} 则消息)
          </div>
          <AnimatePresence>
            {messages.map(
              (msg) =>
