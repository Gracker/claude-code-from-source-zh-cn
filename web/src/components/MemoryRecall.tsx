    ...
    memories: [
      {
        ...
        name: "测试政策",
        description: "整合测试必须打真实数据库，不允许用 mock",
        type: "feedback",
        age: "3 days",
        selected: true,
      },
      ...
      },
      {
        ...
        name: "数据库迁移",
        description: "目前正从 Prisma 迁移到 Drizzle ORM",
        type: "project",
        age: "5 days",
        selected: true,
      },
      ...
      },
      {
        ...
        name: "AWS 设置",
        description: "RDS 实例详情、连线字符串、IAM 角色",
        type: "reference",
        age: "3 weeks",
        selected: false,
      },
      ...
      },
      {
        ...
        name: "环境变量",
        description: "绝不提交 .env 文件，使用 vault 管理机密",
        type: "feedback",
        age: "6 days",
        selected: false,
      },
    ...
    memories: [
      {
        ...
        name: "代码风格",
        description: "使用 Biome 格式化，不用分号，2 空格缩排",
        type: "feedback",
        age: "2 days",
        selected: true,
      },
      ...
      },
      {
        ...
        name: "命名惯例",
        description: "函数用 camelCase，组件/类型用 PascalCase",
        type: "feedback",
        age: "1 week",
        selected: true,
      },
      ...
      },
      {
        filename: "reference_drizzle.md",
        name: "Drizzle 设置",
        description: "Drizzle ORM 设置、迁移指令、studio URL",
        type: "reference",
        age: "2 weeks",
        selected: false,
      },
  ...
  },
  {
    ...
    memories: [
      ...
      },
      {
        ...
        name: "团队分工",
        description: "Alex 负责 auth，Sara 负责计费，Dev 负责前端",
        type: "project",
        age: "4 days",
        selected: true,
      },
      {
        ...
        name: "Linear 看板",
        description: "项目追踪器 URL、冲刺看板、待办事项链接",
        type: "reference",
        age: "3 weeks",
        selected: false,
      },
...
const pipelineStages: {
...
}[] = [
  {
    id: "prefetch",
    label: "预取触发",
    description: "非同步，与使用者查询处理并行",
  },
  {
    id: "manifest",
    label: "构建清单",
    description: "scanMemoryFiles 读取所有 .md 文件，解析 frontmatter（最多 30 行）",
  },
  {
    id: "evaluate",
    label: "Sonnet 评估",
    description: "侧查询接收清单 + 使用者查询 + 最近使用的工具",
  },
  {
    id: "select",
    label: "选取相关项目",
    description: "Sonnet 通过结构化 JSON 输出返回最多 5 个档名",
  },
  {
    id: "inject",
    label: "注入并附加过期警告",
    description: "选中的记忆附加过期警告后注入",
  },
];
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  padding: "10px 12px",
                  borderRadius: 8,
                  border:  INLINECODE3 ${colors.terracotta}60 INLINECODE4 ,
        ...
        <AnimatePresence>
          {stageReached("inject") && !isAnimating && (
            ...
            >
              ...
              >
                选中的记忆以 relevant_memories 附件注入，并附带过期警告。超过一天的记忆会包含过期提示：「在根据记忆提供建议之前，请先与当前代码核实。」
              </div>
            </motion.div>
          )}
        </AnimatePresence>
